...
## gpg for github repo automation for macOS

```bash


###############################################################################
# gpg_github : gpg for github repo automation for macOS (version 1.2.0)
...
# Usage: gpg_github {init|reset|version|help}
